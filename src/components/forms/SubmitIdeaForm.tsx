...
import { useSubmitIdea } from "../../hooks/useIdea"
...
export default function SubmitIdeaForm() {
  ...
  if (mutation.isSuccess) {
    return (
      <div className="text-center py-12 space-y-3">
        ...
        <h3 className="text-lg font-bold text-gray-800">Idea Submitted!</h3>
        <p className="text-gray-500 text-sm">Your idea has been received. We'll be in touch soon.</p>
        <button
  ...
  return (
    <div>
      <h3 className="text-xl font-bold text-gray-800 text-center">Ready to submit your idea?</h3>
      <p className="text-gray-500 text-sm text-center mt-1 mb-1">
        Provide us with some of your information and a description of your idea.
      </p>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        {/* Description */}
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Description of Your Idea</label>
          <textarea
